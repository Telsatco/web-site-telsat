...
export const clients: Client[] = [
  new Client({ company: "SURA", link: "./assets/clients/logo-sura.png", size: {x: "120", y: "50"} }),
  new Client({ company: "A&C", link: "./assets/clients/logo-A&C-2.png", size: {x: "90", y: "100"} }),
  new Client({ company: "CONVEL", link: "./assets/clients/logo-convel.png", size: {x: "150", y: "50"} }),
  new Client({ company: "CASA", link: "./assets/clients/logo-casa.png", size: {x: "100", y: "100"} }),
  new Client({ company: "AIA", link: "./assets/clients/logo-aia.png", size: {x: "200", y: "100"} }),
  new Client({ company: "CONCONCRETO", link: "./assets/clients/logo-conconcreto.png", size: {x: "100", y: "100"} }),
  new Client({ company: "FAC", link: "./assets/clients/logo-fac.png", size: {x: "200", y: "100"} }),
  new Client({ company: "MENSULA", link: "./assets/clients/logo-mensula.png", size: {x: "200", y: "100"} }),
  new Client({ company: "ORBIS", link: "./assets/clients/logo-orbis.png", size: {x: "200", y: "100"} }),
  new Client({ company: "PINTUCO", link: "./assets/clients/logo-pintuco.png", size: {x: "200", y: "100"} }),
  new Client({ company: "INTERVE", link: "./assets/clients/logo-interve.png", size: {x: "200", y: "100"} }),
]

export const providers: Client[] = [
  new Client ({ company: "DEISTER", link: "./assets/providers/logo-deister.png", size: {x: "120", y: "50"} }),
  new Client ({ company: "HONEYWELL", link: "./assets/providers/logo-honeywell.png", size: {x: "90", y: "100"} }),
  new Client ({ company: "TCC", link: "./assets/providers/logo-tcc.svg", size: {x: "150", y: "50"} }),
  new Client ({ company: "VELCO", link: "./assets/providers/logo-velco.png", size: {x: "100", y: "100"} }),
  new Client ({ company: "VICON", link: "./assets/providers/logo-vicon.png", size: {x: "200", y: "100"} }),
  new Client ({ company: "WOLPAC", link: "./assets/providers/logo-wolpac.png", size: {x: "100", y: "100"} }),
  new Client ({ company: "HID", link: "./assets/providers/logo-hid.png", size: {x: "100", y: "100"} }),
]
...
export const sectors: Sector[] =[
  new Sector({ id: "0", caption: "TELECOMUNICACIONES", parent: "", children: true, image: '' }),
    new Sector({ id: "1", caption: "En vhf y uhf", parent: "0", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "2", caption: "Radios portátiles y bases", parent: "0", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "3", caption: "Enlaces para video a larga distancia y satelital", parent: "0", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "4", caption: "Ndb (non direccional beacon)", parent: "0", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
  new Sector({ id: "5", caption: "SEGURIDAD", parent: "", children: true, image: '' }),
    new Sector({ id: "6", caption: "CCTV", parent: "5", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    ...
    new Sector({ id: "19", caption: "Sistemas de control de acceso", parent: "5", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    ...
    new Sector({ id: "34", caption: "Detección y protección", parent: "5", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    ...
    new Sector({ id: "45", caption: "Seguridad humana", parent: "5", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    ...
    new Sector({ id: "59", caption: "Centro de monitoreo (BASS)", parent: "5", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    ...
    new Sector({ id: "62", caption: "Control de mantenimiento preventivo y correctivo", parent: "5", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
  new Sector({ id: "63", caption: "AERONAUTICA", parent: "", children: true, image: '' }),
    new Sector({ id: "64", caption: "Diseño y fabricación de aviones en compuestos", parent: "63", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    ...
    new Sector({ id: "73", caption: "Fotografía aérea con aeronaves no tripuladas", parent: "63", children: true, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
  ...
  new Sector({ id: "84", caption: "QUIMICO Y COMPUESTOS", parent: "", children: true, image: '' }),
    new Sector({ id: "85", caption: "Resinas epoxicas", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "86", caption: "Resinas vinilester", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "87", caption: "Resinas poliéster", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "88", caption: "Fibras de carbono", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "89", caption: "Fibras de vidrio", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "90", caption: "Espumas", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "91", caption: "Carbón activado", parent: "84", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
  new Sector({ id: "92", caption: "AUTOMATIZACIÓN", parent: "", children: true, image: '' }),
    new Sector({ id: "93", caption: "Control de iluminación", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "94", caption: "Control de aire acondicionado", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "95", caption: "Control de consumos", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "96", caption: "Control de motores y procesos", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "97", caption: "Control automático de parqueaderos", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "98", caption: "Puertas y barreras automáticas", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "99", caption: "Monitoreo de variables y ambientes", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "100", caption: "Control de ascensores", parent: "92", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
  new Sector({ id: "101", caption: "ENERGÍAS ALTERNATIVAS", parent: "", children: true, image: '' }),
    new Sector({ id: "102", caption: "Sistemas de generadores eólicos", parent: "101", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "103", caption: "Paneles fotovoltaicos", parent: "101", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "104", caption: "Calentadores de agua", parent: "101", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
    new Sector({ id: "105", caption: "Micro turbinas", parent: "101", children: false, image: 'http://hd.wallpaperswide.com/thumbs/night_landscape-t2.jpg' }),
];
